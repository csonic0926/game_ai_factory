# Objective Gameplay — `<OBJECTIVE_ID>`
...
- Objective completion condition: TBD
- Player-visible completion response: TBD
- Successor objective/handoff: `WIRED | MISSING | UNKNOWN` — TBD
